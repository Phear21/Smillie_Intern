            ...
            <h1 className='flex justify-center items-center font-bold text-[40px] m:text-[50px] h-[20%]'>
                Make remote work
                  ...
                  <p className=' h-[20%]  mb-4 m:h-[15%] m:mb-0 px-3 font-normal text-[18px] lg:text-[18px] text-gray'>
                    Get your team in sync, no matter your location. <br className='md:hidden'/>
                    Streamline processes, create team rituals, <br className='md:hidden'/>and watch productivity soar.
                  </p>
                  ...
                  <div className='flex justify-center w-full md:w-[80%] mt-4 h-[20%] items-center gap-[4vw] md:gap-[8vw]'>
